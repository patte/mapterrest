...
import { orbit, orbitAbout, type Orbit } from './orbit';
 ...
 *
 * The camera orbits the terrain in view rather than the map centre — the turn itself is
 * [orbit.ts](orbit.ts), which point and why it matters in the mountains is
 * [pivot.ts](pivot.ts).
 *
