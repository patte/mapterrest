...
// A z1 contour tile asks for the DEM two levels up, which maplibre-contour floors at z0
// (onthegomap/maplibre-contour#435); without the floor the fetch fails and the zoom-out traces nothing.
